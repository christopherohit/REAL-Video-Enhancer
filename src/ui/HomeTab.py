...
class HomeTab:
    ...
    def getChangelog(self):
        changeLog = ""
        response = requests.get("https://api.github.com/repos/tntwise/real-video-enhancer/releases")
    ...
    def QConnect(self):
        ...
        self.parent.kofiBtn.clicked.connect(lambda: openLink("https://ko-fi.com/tntwise"))
